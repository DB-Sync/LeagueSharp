namespace Teemo
{
    ...
    // To add a shroom location, go to LeagueSharp's AppData folder LSXXXXXXXX/Teemo/Map Name/(xFile.txt, yFile.txt, zFile.txt) and modify the values to suite your needs.
    // This code has been modified by DBSync
